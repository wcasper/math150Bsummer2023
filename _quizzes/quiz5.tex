...
\headandfoot{Calculus II}{Quiz 5}{}
\begin{document}

\begin{enumerate}[\textbf{Problem} 1.]
\item

For which values of $c$ is $y=c/x^2$ a solution of the differential equation
...
Determine a solution of the initial value problem
